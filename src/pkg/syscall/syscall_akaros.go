...
func Syscall6Wrapper(trap, a1, a2, a3, a4, a5, a6 uintptr) (r1, r2 uintptr, err Errno) {
	...
	// EUNSPECIFIED errno.
	errno := Errno(__err)
	if errno == Errno(EUNSPECIFIED) && __r1 != -1 {
		errno = Errno(0)
	}
	return uintptr(__r1), r2, errno
}
...
func socketcall(call int, a0, a1, a2, a3, a4, a5 uintptr) (n int, err Errno) { return n, err }
func rawsocketcall(call int, a0, a1, a2, a3, a4, a5 uintptr) (n int, err Errno) { return n, err }
