...
var geese = []string{"akaros", "android", "darwin", "dragonfly", "freebsd", "linux", "nacl", "netbsd", "openbsd", "plan9", "solaris", "windows"}
...
func TestDependencies(t *testing.T) {
	if runtime.GOOS == "nacl" || runtime.GOOS == "akaros" {
		// NaCl and Akaros tests run in a limited file system and do not
