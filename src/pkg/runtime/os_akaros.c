...
runtime·futexsleep(uint32 *addr, uint32 val, int64 ns)
{
	...
	// Some Akaros kernels have a bug where futex of
...
// from the ELF AT_RANDOM auxiliary vector (vdso_akaros_amd64.c).
...
runtime·setsig(int32 i, GoSighandler *fn, bool restart)
{
	...
	sa.sa_mask = ~0ULL;
	// TODO(adonovan): Akaros manpage says "sa_restorer element is
